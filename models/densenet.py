...
class DenseNet(nn.Module):
    def __init__(self, block, nblocks, growth_rate=12, reduction=0.5, num_classes=10, input_normalization=True):
...
def DenseNet121(num_classes, input_normalization):
    return DenseNet(Bottleneck, [6,12,24,16], growth_rate=32,num_classes=num_classes, input_normalization=input_normalization)
